---
layout: legal
title: "Terms of Service for NeonRoutine"
...
language_code: en
language_order: 2
permalink: /neonroutine/terms.en.md
---
# Terms of Service for NeonRoutine
...
For details on how we collect and process your data, please refer to our [Privacy Policy](https://timonply.com/neonroutine/privacy.en.md).

## 2. Subscriptions, In-App Purchases & Right of Withdrawal
...
**For EU Users (14-Day Right of Withdrawal):**
Before completing a digital subscription purchase, you will be asked to expressly consent to the immediate provision of digital content and to expressly acknowledge that you thereby waive your 14-day right of withdrawal pursuant to § 356(5) BGB (implementing Directive 2011/83/EU). A confirmation of your purchase and this acknowledgment is provided to you on a durable medium (e.g., email receipt from the respective app store). You may cancel your subscription at any time for future billing periods via Apple's or Google's store subscription management settings.
...
- Attempt to bypass any security mechanisms or use the App to distribute malware.
...
## 15. Contact & Legal Notice (Impressum)
...
Full legal notice (Impressum) pursuant to § 5 DDG: [https://timonply.com/impressum.en.md](https://timonply.com/impressum.en.md)
