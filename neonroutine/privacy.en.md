...
- On iOS, the Identifier for Advertisers (IDFA) may be available only after the user accepts Apple App Tracking Transparency. In the EEA and UK, Google UMP presents consent choices before applicable personalized ads; the choice can be changed or withdrawn from Settings > AD PREFERENCES. See the [Google Privacy Policy](https://policies.google.com/privacy).
