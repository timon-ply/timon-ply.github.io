...
- **Datos Locales de Hábitos**: Sus rutinas y registros se almacenan de forma segura y *exclusivamente local* en su dispositivo (Isar DB).  
  *Base Legal: Interés Legítimo (Art. 6(1)(f) RGPD).*
- **Compras dentro de la aplicación**: Gestionadas a través de RevenueCat y las tiendas de aplicaciones (Apple / Google).  
  *Base Legal: Ejecución de un Contrato (Art. 6(1)(b) RGPD).*
- **Publicidad**: Utilizamos Google AdMob para mostrar anuncios, sujetos a su consentimiento gestionado a través de Google UMP.  
  *Base Legal: Consentimiento Explícito (Art. 6(1)(a) RGPD).*
- **Datos de uso y análisis**: Recopilados de manera anónima a través de Firebase/Crashlytics.  
  *Base Legal: Interés Legítimo / Consentimiento (Art. 6(1)(f) / (a) RGPD).*
...
- **Google Firebase**: Análisis y errores.
- **RevenueCat**: Suscripciones.
- **Apple Inc. / Google LLC**: Transacciones en tiendas.
