...
function docRedirects(appKey, doc, code) {
  return [`/${appKey}/${doc}.${code}`, `/${appKey}/${doc}.${code}.html`, `/${appKey}/${doc}.${code}.md`];
}

function generalRedirects(doc, code) {
  return [`/${doc}.${code}`, `/${doc}.${code}.html`, `/${doc}.${code}.md`];
}
